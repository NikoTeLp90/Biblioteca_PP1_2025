      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mx-auto">
            ...
            </li><li class="nav-item"><a class="nav-link" href="../../php/login/logout.php" id="linkSalir">Salir</a></li>
          </ul>
        </div>
      </div>
    </nav>
            ...
            <tr>
              ...
              <td>
                <div class="btn-group btn-group-sm">
                  <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalEditarInsumo" onclick="cargarDatosEdicion({&quot;id&quot;:&quot;8&quot;,&quot;nombre&quot;:&quot;cable hdmi&quot;,&quot;categoria&quot;:&quot;Otro&quot;,&quot;disponibilidad&quot;:&quot;Disponible&quot;,&quot;estado&quot;:&quot;Disponible&quot;,&quot;observaciones&quot;:&quot;cable&quot;})">
                    <i class="bi bi-pencil-square"></i> Editar
                  </button>
                  <button type="button" class="btn btn-outline-danger" onclick="confirmarEliminacion(8, 'cable hdmi')">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="agregar_insumo.php" method="POST" id="registroInsumo">
              ...
              <div id="contenedorInsumos"><div class="row mb-3"><div class="col-md-6"><div class="card h-100">
                <div class="card-header bg-light">
                  <strong>Insumo 1</strong>
                </div>
                <div class="card-body">
                  <div class="mb-3">
                    <label for="nombre_1" class="form-label fw-bold">Nombre</label>
                    <input type="text" class="form-control" id="nombre_1" name="nombres[]" required="">
                  </div>
                  <div class="mb-3">
                    <label for="observacion_1" class="form-label fw-bold">Observación</label>
                    <textarea class="form-control" id="observacion_1" name="observaciones[]" rows="2"></textarea>
                  </div>
                </div>
              </div></div></div></div>
